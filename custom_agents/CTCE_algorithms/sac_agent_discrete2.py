...
from ..SAC_components.actor_discrete2 import DiscreteActor
...
class Agent:
    ...
    def learn(self):
        ...
        # compute Q-values
        q1_policy = self.critic1.forward(obs, act_prev_obs)
        q2_policy = self.critic2.forward(obs, act_prev_obs)
