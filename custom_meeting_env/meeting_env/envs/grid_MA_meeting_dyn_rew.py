...
class grid_meeting_env(ParallelEnv):
    ...
    def dist_sum(self):
        ...
        # generate pairs
        pairs = list(itertools.combinations(self._agent_locations, 2))
        # print(self._agent_locations)
        # print(pairs)
        # calculate pair distances
        distances = [self._euclidean_dist(pair[0], pair[1]) for pair in pairs]
        # print(distances)
        # summation = sum(distances)
        # print(summation)
    ...
    def step(self, actions):
        ...
        if distances == 0:
            ...
            rewards = {a: -0.001 * distances for a in self.possible_agents}
