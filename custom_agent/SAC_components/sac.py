...
class SAC():
    ...
    def criticLoss(self, actor, critic1, critic2, critic1_targ, critic2_targ, alpha, obs, replay_act, next_obs, dones, rewards):
        ...
        with torch.no_grad():
            ...
            policy_actions_next_obs, log_prob_next_obs = actor.normal_distr_sample(next_obs)

            # target q values
            q1_policy_targ = critic1_targ.forward(next_obs, policy_actions_next_obs)
            q2_policy_targ = critic2_targ.forward(next_obs, policy_actions_next_obs)
