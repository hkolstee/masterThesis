...
def main():
    ...
    # create environment
    env = CityLearnEnv(schema=schema_path, reward_function=RewardFunction, central_agent=True, random_seed = 1)
    eval_env = CityLearnEnv(schema=schema_path, reward_function=RewardFunction, central_agent=True, random_seed = 1)
    ...
    # create SAC model
    model = SAC("MlpPolicy", env, tensorboard_log="./tensorboard_logs/", device = "cuda", seed = 13, learning_rate = 0.0001)
    # set env
    model.set_env(env)
