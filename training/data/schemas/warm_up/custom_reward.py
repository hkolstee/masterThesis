...
class CustomReward(RewardFunction):
    ...
    def unmetThermalComfort(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    # NOTE: Baseline
    def carbonEmissions(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    def ramping(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    # NOTE: Baseline
    def loadFactor(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    # NOTE: Baseline
    def dailyPeak(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    def allTimePeak(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    def thermalResilience(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    def normalizedUnservedEnergy(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
    ...
    def unservedEnergyAlternative(self, observations: List[Mapping[str, Union[int, float]]]) -> np.ndarray[float]:
