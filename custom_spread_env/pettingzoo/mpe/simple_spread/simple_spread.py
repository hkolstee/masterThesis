...
from ...mpe._mpe_utils.core import Agent, Landmark, World
from ...mpe._mpe_utils.scenario import BaseScenario
from ...mpe._mpe_utils.simple_env import SimpleEnv, make_env
...
class Scenario(BaseScenario):
    ...
    def observation(self, agent, world):
        """
        This function has been altered to give all positions for all agents and landmarks, and 
        all velocities of all agents.
        """
        ...
        for agents in world.agents:
            agents_pos.append(agents.state.p_pos)
            agents_vel.append(agents.state.p_vel)            
        return np.concatenate(
            entity_pos + agents_pos + agents_vel
        )
